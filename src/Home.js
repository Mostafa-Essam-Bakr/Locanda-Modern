...
<Link id="RouterLink" to="/Place"> <li>place</li></Link></ul>
</div>
...
<div className="bs"><button className="b1" type="submit"><Link to="/Book" style={{textDecoration:"none",color:"white",fontSize:"larger"}}>Book your place</Link></button>
<button  className="b2" type="submit" ><Link to="/Hotel"style={{textDecoration:"none",color:"white",fontSize:"larger"}}>Type Hotel</Link></button></div>
