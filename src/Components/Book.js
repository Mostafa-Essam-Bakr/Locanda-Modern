...
export default function Book (){
    ...
    <div><nav className="navhom" style={{ width:"100%",display:"flex",justifyContent:"space-around",alignItems:"center",color:"white",height:"50px",
...
<Link to="/" className="h1 s" ><i className="fa-solid fa-arrow-right-from-bracket"></i> Go Home </Link>
    ...
    <div className="congra" style={{display: `${cong === false?"block":"none"}`}}><h1>Congratulations {name}</h1>
    
    <h2>the {City} city has been booked successfully</h2><h2>We wish you a happy trip on {Date}</h2> 
<div style={{display:"flex",justifyContent:"center"}}> <i style={{color:" #06ff06",fontSize:"xxx-large"}} className="fa-solid fa-house-circle-check"></i>
    ...
    <div className="pfrm1" style={{display: `${cong === false?"none":"flex"}`}}>
        <form className="frm1" onSubmit={Submit} >

            <label htmlFor="name"> Name </label>
            <input type="text" name="LastName" placeholder="Name" id="name" value={name} 
            ...
            <h4 style={{color:"white",fontFamily:"fantasy"}}>Book in a country</h4>
      ...
      <option value="Portugal"  >Portugal</option>
            ...
            <input type="Date" name="Date" placeholder="Date" id="Date"  value={Date} required
